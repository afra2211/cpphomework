...
std::vector<Card> CardFactory::createAge2Deck() {
  ...
  add(createRawMaterialCard("SHELF QUARRY", 3, {}, {{ResourceType::STONE, 2}},
                            0));
  ...
  add(createMilitaryCard("WALLS", 0, {{ResourceType::STONE, 3}}, 2, "",
                         "FORTIFICATIONS"));
  ...
  add(createScientificCard("LIBRARY", 0,
                           ...
                           0, ScienceSymbol::TABLET, "THEATER", "UNIVERSITY"));
  add(createScientificCard("DISPENSARY", 0,
                           {{ResourceType::GLASS, 1}, {ResourceType::CLAY, 1}},
                           0, ScienceSymbol::COMPASS, "APOTHECARY", "LODGING"));
  add(createScientificCard("SCHOOL", 0,
                           {{ResourceType::PAPER, 1}, {ResourceType::WOOD, 1}},
                           1, ScienceSymbol::GEAR, "SCRIPTORIUM", "STUDY"));
  add(createScientificCard(
      "LABORATORY", 0, {{ResourceType::PAPER, 1}, {ResourceType::CLAY, 2}}, 0,
      ScienceSymbol::MORTAR, "PHARMACIST", "OBSERVATORY"));
...
std::vector<Card> CardFactory::createAge3Deck() {
  ...
  add(createMilitaryCard("FORTIFICATIONS", 0, {{ResourceType::STONE, 3}}, 3,
                         "WALLS"));
  add(createMilitaryCard(
      "CIRCUS", 0, {{ResourceType::STONE, 2}, {ResourceType::CLAY, 1}}, 2));
  add(createMilitaryCard("ARSENAL", 0,
                         {{ResourceType::WOOD, 2},
                          {ResourceType::CLAY, 1},
                          {ResourceType::GLASS, 1}},
                         3));
  ...
  add(createScientificCard("UNIVERSITY", 0,
                           ...
                           2, ScienceSymbol::TABLET, "LIBRARY"));
  add(createScientificCard("OBSERVATORY", 0,
                           {{ResourceType::GLASS, 2}, {ResourceType::CLAY, 1}},
                           2, ScienceSymbol::COMPASS, "DISPENSARY"));
  add(createScientificCard("STUDY", 0,
                           {{ResourceType::PAPER, 1}, {ResourceType::WOOD, 2}},
                           2, ScienceSymbol::GEAR, "SCHOOL"));
  ...
  add(createCivilianCard("GARDENS", 0,
                         {{ResourceType::WOOD, 2}, {ResourceType::CLAY, 1}}, 6,
                         "STATUE"));
  add(createCivilianCard(
      "TOWN HALL", 0, {{ResourceType::STONE, 2}, {ResourceType::GLASS, 1}}, 7));
  ...
  add(createCommercialCard(
      "ARMORY", 0, {{ResourceType::CLAY, 2}, {ResourceType::WOOD, 1}}, 3, 0));
  add(createCommercialCard("CHAMBER OF COMMERCE", 0,
                           {{ResourceType::PAPER, 1}, {ResourceType::STONE, 2}},
                           3, 0));
